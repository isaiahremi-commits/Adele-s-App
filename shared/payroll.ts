// Pay-period math for the Manadele pay engine — shared by the Next.js app
// and the Expo app (Metro only watches shared/, so this is the one directory
// both can import at runtime; lib/payroll.ts re-exports from here).
//
